...
const About = () => {
	return (
		<div name="about" className="h-screen w-full bg-gradient-to-b from-teal-100 to-white">
			<div className="max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px4 md:flex-row">
				<div className="flex flex-col justify-center h-full">
					<h2 className="text-3xl sm:text-3xl font-bold">
						Third year student at Memorial University of Newfoundland with a Computer Science major and
						Mathematics Minor
					</h2>
					<p className="text-grey-700 py-4 max-w-md">
						Skilled in Unity game development, augmented reality, and web technologies (React, Bootstrap,
						and Tailwind CSS). Experienced in data optimization through SQL queries. Led a graphic design
						team for the Memorial University Student Volunteer Bureau and currently serving as the WebMaster
						for the Muslim Student Association. Pursuing AWS Cloud Practitioner certification and actively
						working on a personal portfolio website, crafted with React and Tailwind CSS, deployed using AWS
						Amplify. Eager to contribute skills, creativity, and strong work ethic to innovative projects
					</p>
				...
				<div>
					<img src={Photo} alt="my profile" className="rounded-2xl mx-auto w-1/2 md:w-3/4" />
				</div>
			</div>
		</div>
	);
